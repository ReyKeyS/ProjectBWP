...
('DS00001','HS0001','PR0005',2,5744000),
('DS00002','HS0002','PR0009',1,6880000),
('DS00003','HS0002','PR0016',1,1100000),
('DS00004','HS0002','PR0022',1,1500000),
('DS00005','HS0002','PR0024',1,1450000),
('DS00006','HS0002','PR0031',1,750000),
('DS00007','HS0002','PR0034',1,500000),
('DS00008','HS0002','PR0042',2,800000),
('DS00009','HS0002','PR0048',1,600000),
('DS00010','HS0003','PR0020',1,5995000),
('DS00011','HS0004','PR0001',1,1000000),
('DS00012','HS0004','PR0005',1,2872000),
('DS00013','HS0004','PR0006',1,1000000),
('DS00014','HS0004','PR0007',1,3700000),
('DS00015','HS0004','PR0022',1,1500000),
('DS00016','HS0004','PR0035',1,670000),
('DS00017','HS0004','PR0044',1,1890000),
('DS00018','HS0004','PR0048',1,600000),
('DS00019','HS0005','PR0007',1,3700000),
('DS00020','HS0005','PR0027',1,1400000),
('DS00021','HS0006','PR0011',1,13872000),
('DS00022','HS0006','PR0017',1,1600000),
('DS00023','HS0006','PR0021',1,2100000),
('DS00024','HS0006','PR0026',1,5400000),
('DS00025','HS0006','PR0029',1,340000),
('DS00026','HS0006','PR0036',1,1100000),
('DS00027','HS0006','PR0043',1,780000),
('DS00028','HS0006','PR0048',1,600000),
('DS00029','HS0007','PR0005',1,2872000),
('DS00030','HS0007','PR0019',1,2700000);
...
CREATE TABLE `htrans` (
  ...
  `status` int(11) NOT NULL COMMENT '0=Berhasil, 1=Menunggu, 2=Batal',
...
('HS0001','US0003','INV221202001','2022-12-02 12:11:46',0,5744000,1),
('HS0002','US0001','INV221202002','2022-12-02 12:20:15',1,13700000,1),
('HS0003','US0001','INV221216001','2022-12-16 14:09:27',0,5995000,1),
('HS0004','US0001','INV221216002','2022-12-16 14:10:08',1,13352000,1),
('HS0005','US0001','INV221216003','2022-12-16 14:10:30',0,5100000,2),
('HS0006','US0003','INV221216004','2022-12-16 14:14:20',1,25912000,0),
('HS0007','US0004','INV221216005','2022-12-16 15:28:22',0,5572000,1);
...
('PR0002','Logitech G102','Garansi Perangkat Keras Terbatas 2 Tahun Tolong simpan dan sertakan kemasan dan nota. Untuk komplain seperti salah barang dan cacat fisik, tolong menyertakan video unboxing.',250000,17,'Logitech','CA001','products/logitech-g102.jpeg',1),
('PR0003','Colorful RTX 3050 NB Triple Fan','Merk NVIDIA, keluaran terbaru. barang asli dari pabrik',4500000,12,'NVIDIA','CA003','products/rtx-3050-colorful.jpg',1),
('PR0004','AMD Ryzen 5 3600','Brand : AMD CPU Socket Type : AM4 Processors Generation : 3rd Gen Ryzen Family : AMD Ryzen Cores : 6 Threads : 12 Operating Frequency : 3.6GHz Max Turbo Frequency : 4.2GHz Cache : 32 MB Manufacturing Tech : TSMC 7 nm FinFET Integrated Graphics : No Therma',2000000,7,'AMD','CA004','products/ryzen5-3600.jpeg',1),
('PR0005','Gigabyte Aorus B550','AMD Socket AM4, support for: AMD Socket AM4, support for: AMD Ryzen™ 5000 Series/ Ryzen 5000 G-Series/ 3rd Gen Ryzen™ and 3rd Gen Ryzen™ with Radeon™ Graphics Processors',2872000,3,'Gigabyte','CA005','products/Gigabyte-B550-Aorus.jpeg',1),
...
('PR0007','Colorful GTX 3050 NB Dual fan','VGA GTX terbaru merk NVIDIA',3700000,4,'NVIDIA','CA003','products/vgacolorful.jpg',1),
('PR0008','VGEN Platinum ','Ram Merek VGEN. Garansi Lifetime',178000,1,'VGEN','CA006','products/vgaplatinum.jfif',1),
...
('PR0016','Intel i3 10100f','Spesifikasi Inti Intel Core i3-10100F\r\nProduct Collection 10th Generation Intel Core i3 Processors\r\nCode Name Comet Lake\r\nLithography 14 nm\r\n# of Cores 4\r\n# of Threads 8\r\nProcessor Base Frequency 3.60 GHz\r\nMax Turbo Frequency 4.30 GHz\r\nCache 6 MB Intel Sm',1100000,2,'Intel','CA004','products/intel_intel_core_i3-10100f_i3_10100f_3-6ghz_up_to_4-3ghz_box_socket_lga_1200__full01_mvbw37ud.jpg',1),
('PR0017','Intel i5 9400f','Processor Name : Intel Core i5-9400F 2.9Ghz Up To 4.1Ghz - Cache 9MB [Box] Socket LGA 1151V2 - Coffeelake Series\r\nBrand : Intel\r\nCPU Socket Type : LGA 1151V2\r\nProcessors Generation : 9th Gen\r\nFamily : Coffeelake\r\nCores : 6\r\nThreads : 6\r\nOperating Frequenc',1600000,2,'Intel','CA004','products/7e5d346c3466baa8c0e93de88a80b649.jpg',1),
('PR0018','Intel i7 10700','Intel I7 keluaran terbaru. garansi original',5000000,3,'Intel','CA004','products/intel_processor_intel_core_i7_10700f_i7-10700f_2-90_ghz_lga_1200_box_full01_rg6ca6ju.jpg',1),
...
('PR0029','RAM DDR4 SODimm V-GeN RESCUE 8GB PC19200/2400Mhz (Memory Laptop VGEN)','Dimensi : 68mm x 30mm x 2mm\r\nKecepatan : 2400Mhz\r\nChipset : V-GeN\r\nSlot : DIMM 260 Pin\r\nType : Unbuffered\r\nVoltage : 1.2V\r\nECC : No\r\nRegistered : No\r\nGaransi : Limited Lifetime Warranty',340000,9,'VGEN','CA006','products/4c56936f-4787-4709-b3ec-d42d951c5d12.jpg',1),
...
('PR0040','Deepcool Castle 360 RGB','DEEPCOOL LIQUID COOLING\r\n\r\nTechnical Spec\r\n\r\nPump Dimensions\r\n91×79×71 mm\r\n\r\nRadiator Dimensions\r\n402×120×27 mm\r\n\r\nRadiator Material\r\nAluminum\r\n\r\nNet Weight\r\n1768 g\r\n\r\nTube length\r\n465 mm\r\n\r\nPump Speed\r\n2550 RPM±10%\r\n\r\nPump Noise\r\n17.8 dB(A)\r\n\r\nPump Conne',1780000,2,'DeepCool','CA009','products/131283.jpg',1),
...
('PR0043','VGEN SSD 512 GB','Spesifikasi M.2 SATA:\r\nCapacity: 128GB, 256GB, 512GB, 1TB, 2TB\r\nInterface: M.2 / AHCI\r\nForm Factor: M.2 (2280)\r\nController: Asolid / Silicon Motion\r\nRead Speed: Up to 550 MB/s\r\nWrite Speed: Up to 520 MB/s\r\nGaransi Resmi 3 Tahun (Rusak langsung tukar, tida',780000,6,'VGEN','CA010','products/https_s1.bukalapak.com_img_13619532981_large_data.jpeg',1),
...
('PR0052','Logitech Pro X RGB Tacticle Linear','SPESIFIKASI FISIK\r\nTinggi: 34 mm\r\nLebar: 361 mm\r\nTebal: 153 mm\r\nGX BLUE CLICKY SWITCH\r\nJarak aktuasi: 2,0 mm\r\nKekuatan aktuasi: 50 g\r\nTotal jarak: 3,7 mm\r\nGX BROWN TACTILE SWITCH\r\nJarak aktuasi: 2,0 mm\r\nKekuatan aktuasi: 50 g\r\nTotal jarak: 3,7 mm\r\nGX RED ',1549000,63,'Logitech','CA002','products/9a58a7c4-16f0-4656-b6e5-c0bd8c4dfa7e.jpg',1),
('PR0053','Razer BlackWidow V3 - Yellow Switch','Mechanical Gaming Keyboard with Razer Chroma RGB\r\n\r\nRazer™ Yellow Mechanical Switches\r\nTransparent switch housing\r\nDoubleshot ABS keycaps\r\n\r\nTECH SPECS:\r\n\r\nSWITCH TYPE: Razer™ Yellow Mechanical Switch\r\nKEY FEEL: Linear and Silent\r\nSIZES: Full Size\r\nLIGHTI',1500000,3,'Razer','CA002','products/razer-blackwidow-v3-black-02.jpg',1),
('PR0054','INtel','produk test',40000,5,'Asus','CA001','products/9432cdd515ab3d772334e471e230c211.jpg',1);
...
('US0001','Ryan','ryk@gmail.com','082233645874','Jl Klampis','123',1),
('US0002','Michael Lukas Tjandra','lukastjan13@gmail.com','089517508300','lukastjan13@gmail.com','123',1),
('US0003','Paddy','paddy@gmail.com','081234567894','Ngagel','123',1),
('US0004','thuan','thuan@gmail.com','081234567890','Ngagel','123',1),
('US0005','Rd','ricat@gmail.com','08213','Ngagel Jaya Tengah 52','c20ad4d76fe97759aa27a0c99bff6710',1);
